...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_default_template_processor_js__ = __webpack_require__(9);
...
/* unused harmony reexport defaultTemplateProcessor */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_directive_js__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_part_js__ = __webpack_require__(11);
/* unused harmony reexport noChange */
/* unused harmony reexport nothing */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__lib_parts_js__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__lib_render_js__ = __webpack_require__(12);
/* unused harmony reexport parts */
/* unused harmony reexport render */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__lib_template_factory_js__ = __webpack_require__(6);
/* unused harmony reexport templateCaches */
/* unused harmony reexport templateFactory */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__lib_template_instance_js__ = __webpack_require__(4);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__directive_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dom_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__part_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__template_instance_js__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_redux_dynamic_reducer__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_dot_prop_immutable__ = __webpack_require__(35);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__parts_js__ = __webpack_require__(3);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dom_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__parts_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__template_factory_js__ = __webpack_require__(6);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
Object.defineProperty(exports, "__esModule", { value: true });
const lit_element_1 = __webpack_require__(19);
const reducer_1 = __webpack_require__(23);
const dynamic_redux_1 = __webpack_require__(7);
const CartApi_1 = __webpack_require__(36);
class MyCart extends lit_element_1.LitElement {
    ...
    render() {
        return lit_element_1.html `<h1>Cart</h1>
                ${this.numberOfNames > 0 ? lit_element_1.html `
                <h3>Names:</h3>
                <ul>
                   ${Object.keys(this.names).map(item => lit_element_1.html `<li><b>${this.names[item]["data"]["name"]}:</b><br>${this.names[item]["abstract"]}</li><br>`)}
                </ul>
                <hr>
                ` : lit_element_1.html ``}
                
                ${this.numberOfInfo > 0 ? lit_element_1.html `
                <h3>Info:</h3>
                <ul>
                   ${Object.keys(this.info).map(item => lit_element_1.html `<li>Name:<b>${this.info[item]["data"]["name"]}</b><br>
    ...
    resetDataAndCallGetAbstract() {
        ...
        CartApi_1.GetAbstract(this.numberOfNames, this.store, this.propPath);
...
__decorate([
    ...
    __metadata("design:type", Object)
], MyCart.prototype, "names", void 0);
__decorate([
    lit_element_1.property({ type: Array }),
    __metadata("design:type", Object)
], MyCart.prototype, "info", void 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lit_html_lib_shady_render_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_updating_element_js__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_decorators_js__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__lib_css_tag_js__ = __webpack_require__(14);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dom_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modify_template_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__render_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__template_factory_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__template_instance_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__template_js__ = __webpack_require__(0);
...
Object.defineProperty(exports, "__esModule", { value: true });
const actions_1 = __webpack_require__(15);
const dynamic_redux_1 = __webpack_require__(7);
const initialState = {
    namesByID: {},
    infoByID: {},
...
function AddNamesToCart(state, action) {
    ...
    counter++;
    let newState = dynamic_redux_1.set(state, 'namesByID' + '.' + counter + '.data', action.payload);
    newState = dynamic_redux_1.set(newState, 'numberOfNames', counter);
    newState = dynamic_redux_1.set(newState, 'abstractUpdated', false);
    return newState;
}
function AddInfoToCart(state, action) {
    let counter = state.numberOfInfo;
    counter++;
    let newState = dynamic_redux_1.set(state, 'infoByID' + '.' + counter + '.data', action.payload);
    newState = dynamic_redux_1.set(newState, 'numberOfInfo', counter);
    return newState;
}
function UpdateAbstractInCart(state, action) {
    let itemIndex = state.numberOfNames;
    let newState = dynamic_redux_1.set(state, 'namesByID' + '.' + itemIndex + '.abstract', action.payload);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__ = __webpack_require__(28);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(26), __webpack_require__(27)(module)))
